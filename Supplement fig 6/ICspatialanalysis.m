...
smRIC = smRIC';
for i = 1:100
 smLIC(:,i) = msbackadj(time,smLIC(:,i),'WindowSize',500,'StepSize',500);
 smRIC(:,i) = msbackadj(time,smRIC(:,i),'WindowSize',500,'StepSize',500);
end
...
%% save
dname = 'F:\Calvin\tmem16a\IC widefield tecta spont';
save([dname '\spatialAnalysis.mat'],'eventStats','smLIC','smRIC'); 
%%