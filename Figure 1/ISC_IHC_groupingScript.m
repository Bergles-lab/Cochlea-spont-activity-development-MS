...
%%
ISCstruct = getISCevents(img,fp,name,1);
...
generateISCIHCActivityMovie(img,ISClabels,posIndices,IHClabels,IHCstruct.IHCcenters,[fp '\' name '_coordNew2.mp4'],[475 24000])
