function [FRA,bestF,bandW,bandWidthOct,respMatrixTot] = getFRA6levels(file,dFlim,numLevels,freqsFile,freqInterval)
...
for x = 1:file.numROI
    for y = 1:file.params.numFreqs
       if [file.ROIdF60(y,x).max] >= dFlim
            file.ROIdF60(y,x).active = 1;
       else
           file.ROIdF60(y,x).active = 0;
       end
    end
end
