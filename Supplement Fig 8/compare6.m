function [h, p, handle] = compare6(group1, group2, group3, group4,group5,group6, conditions, ylbl, dim, markSz, color1, color2)
...
%        
      ...
      % plot([6*ones(m5,1) 7*ones(m6,1)]',[group5 group6]','Color',l_grey); % for lines
       ...
       errorbar([0.6], mean1, std1,'LineStyle', 'none','LineWidth',1.5,'Color',color1,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       errorbar([1], mean2, std2,'LineStyle', 'none','LineWidth',1.5,'Color',color2,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       errorbar([1.6], mean3, std3,'LineStyle', 'none','LineWidth',1.5,'Color',color1,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       errorbar([2], mean4, std4,'LineStyle', 'none','LineWidth',1.5,'Color',color2,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       errorbar([2.6], mean5, std5,'LineStyle', 'none','LineWidth',1.5,'Color',color1,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       errorbar([3], mean6, std6,'LineStyle', 'none','LineWidth',1.5,'Color',color2,'CapSize',0,'Marker','.','MarkerSize',meanMarkSize);
       xlim([0.25 3.25]);
       ylim([0 inf])
       xticks([0.6 1 1.6 2 2.6 3]);
       xtickangle([45])
